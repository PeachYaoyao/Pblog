...
import top.peachyao.enums.VisitBehavior;
import top.peachyao.handler.Result;
import top.peachyao.model.dto.VisitLogRemarkDto;
...
public class VisitLogAspect {
     ...
     * @return
     */
    private VisitLog handleLog(ProceedingJoinPoint joinPoint, VisitLogger visitLogger, HttpServletRequest request, Result result, int times, String identification) {
        ...
        VisitLog log = new VisitLog(identification, uri, method, visitLogger.value().getBehavior(), visitLogRemark.getContent(), visitLogRemark.getRemark(), ip, times, userAgent);
     ...
     * @return
     */
    private VisitLogRemarkDto judgeBehavior(VisitBehavior behavior, Map<String, Object> requestParams, Result result) {
        String remark = "";
